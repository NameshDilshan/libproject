...
<!--                   ============================================================== -->                         
	...
	<%-- 							</c:choose> --%>
						...
						<div class="col-md-12">
							...
							<form:select id="member" path="member" class="form-control">
	<%-- 							<c:choose> --%>
	<%-- 								<c:when test="${not empty (issue.book)}"> --%>
	<%-- 									<c:forEach items="${countries}" var="country"> --%>
	<%-- 										<option value="${country.id}" ${((country.name) == (guest.country) ? 'selected' : '')}>${country.name}</option> --%>
	...
	<%-- 								</c:when> --%>
	<%-- 								<c:otherwise> --%>
										<form:option selected="selected" disabled="disabled" value="">Choose Member</form:option>
...
<!-- 						  </div> -->
<!-- 						  <div class="col-md-12"> -->
<!-- 						    <label for="age" class="form-label">Member Name</label>  -->
<%-- 						    <form:input type="number" class="form-control" id="memberName" path="age" required="required"/> --%>
<!-- 						  </div>  -->
						  <div class="col-md-6">
...
<!--                   ============================================================== -->           
											...
											<c:choose>
												<c:when test="${not empty issue }">
													<tr>
														...
														<td><c:out value="${issue.member.name}"></c:out></td> 
        ...
        $(".editBtn").click(function (){
			...
			$('#member option[id=\''+map.get(4)+'\']').attr('selected','selected');
