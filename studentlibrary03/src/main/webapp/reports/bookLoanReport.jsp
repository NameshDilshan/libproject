...
<html lang="en">
    <head>
        <title>Member Fine Report Dashboard</title> 
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Member Fine Report</h3>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item ">Reports</li>
                            <li class="breadcrumb-item active">Member Fine Report</li>
                        </ol> 
					<div class="row">
						<div class="col-md-6">
									...
									<div class="py-4">
										<div class="col-md-12">
											...
											<select id="member" name="member" class="form-control">
												<option selected="selected" disabled="disabled" value="">Choose Member</option>
												<c:forEach items="${members}" var="member">
													<option value="${member.empcode}" id="${ member.name }">${ member.name }</option>
												</c:forEach>
											</select>
										</div>
										<div class="col-md-12">
...
<!--                   ============================================================== -->  
                       ...
                       <div class="card mt-4">
                           <div class="card-header"><i class="fas fa-table me-1"></i> Member Fine Records </div> 
                           <div class="card-body"> 
							<div class="mt-4">
