				  ...
				  <div class="modal-dialog">
				    <div class="modal-content">  
				      ...
				      <div class="modal-body">
				        <form:form class="row g-3" action="saveMember" modelAttribute="member" method="POST">
						  <div class="col-md-6">
											...
											<c:choose>
												<c:when test="${not empty member }">
													<tr>
														...
														<td><c:out value="${member.grade}"></c:out></td> 
														<td><c:out value="${member.classname}"></c:out></td> 
