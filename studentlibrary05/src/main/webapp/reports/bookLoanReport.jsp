...
<html lang="en">
    <head>
        <title>Employee Fine Report Dashboard</title> 
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Employee Fine Report</h3>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item ">Reports</li>
                            <li class="breadcrumb-item active">Employee Fine Report</li>
                        </ol> 
					<div class="row">
						<div class="col-md-6">
									...
									<div class="py-4">
										<div class="col-md-12">
											...
											<select id="employee" name="employee" class="form-control">
												<option selected="selected" disabled="disabled" value="">Choose Employee</option>
										...
										<div class="col-md-12">
											...
											<select id="book" name="book" class="form-control">
												<option selected="selected" disabled="disabled" value="">Choose Book</option>
...
<!--                   ============================================================== -->  
                       ...
                       <div class="card mt-4">
                           <div class="card-header"><i class="fas fa-table me-1"></i> Employee Fine Records </div> 
                           <div class="card-body"> 
							<div class="mt-4">
...
// 		});
	...
	var globelJsonResponse;
		$("#searchBtn").click( function (){ 
			...
			var employee = $('#employee').find(":selected").val(); 
				$.ajax({
					  type: "POST",
				      url: "findIssuesByBookIdAndEmployeeIdAndIssuedDateRange",
				      data: {
				    	  "start": startDate,
				    	  "end" : endDate,
				    	  "book" : book, 
