				  ...
				  <div class="modal-dialog">
				    <div class="modal-content">  
				      ...
				      <div class="modal-body">
				        <form:form class="row g-3" action="saveBookObject" modelAttribute="book" method="POST">
						  <div class="col-md-6">
...
<%-- 						    <form:input type="text" class="form-control" id="edition" path="edition" /> --%>
<!-- 						  </div>  -->
						  <div class="col-md-6">
						    <label for="edition" class="form-label">Edition</label>
...
<!-- 								<option selected="selected" disabled="disabled" value="">Choose...</option> -->
<!-- 								<option value="Adventure" id="adventure">Adventure</option> -->
<%-- 								<option value="Classics" id="classics">Classics</option><form:input type="text" class="form-control" id="category" path="category" /> --%>
<%-- 							</form:select>	 --%>
<!-- 						  </div> -->
...
<!--                   ============================================================== -->           
        ...
        $(".editBtn").click(function (){
			...
			$("#year").val(map.get(3)); 
// 			$("#genre").val(map.get(4)); 
			$("#author").val(map.get(6)); 
			$("#price").val(map.get(7));
			$('#edition option[value=\''+map.get(5)+'\']').attr('selected','selected');
			$('#genre option[value=\''+map.get(4)+'\']').attr('selected','selected');
