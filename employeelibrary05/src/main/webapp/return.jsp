                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Return Book Management</li>
                        </ol> 
<!--                   ============================================================== -->
<!--                   					   Modal START  								-->
<!--                   ============================================================== -->                         
				  ...
				  <div class="modal-dialog">
				    <div class="modal-content">  
				      <div class="modal-header">
				        <h2 class="modal-title">Return Book Record</h2>
				      ...
				      <div class="modal-body">
						...
						<div class="col-md-12">
						  ...
						  <div class="col-md-12 text-center">
						      <button class="btn btn-primary w-100" type="submit">Return Book</button>
						  </div> 
						</form:form>
				      </div>   
				    </div>
...
<!--                   ============================================================== -->           
                       ...
                       <div class="card mt-4">
                           <div class="card-header"> <i class="fas fa-table me-1"></i>Return Book Records</div> 
                           <div class="card-body"> 
							<div class="mt-4">
